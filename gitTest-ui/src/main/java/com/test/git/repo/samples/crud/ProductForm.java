package com.test.git.repo.samples.crud;

import java.util.Collection;

import com.test.git.repo.samples.backend.DataService;
import com.test.git.repo.samples.backend.data.Availability;
import com.test.git.repo.samples.backend.data.Category;
import com.test.git.repo.samples.backend.data.Product;
